...
enum class Weapon(
    ...
    FINGER(
        ...
        brightness = 1.0f, continuous = true,
    ...
    NAIL(
        ...
        brightness = 1.25f, continuous = true,
    ...
    HAMMER(
        ...
        brightness = 0.85f, continuous = false,
    ...
    DRILL(
        ...
        brightness = 1.4f, continuous = true,
    ...
    FIST(
        ...
        brightness = 0.7f, continuous = false,
